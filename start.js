...
async function authenticateGh() {
  if (!process.env.GITHUB_TOKEN) {
    throw new Error('GITHUB_TOKEN is required to clone private or public repos via gh CLI');
  }
  console.log('Authenticating GitHub CLI...');
  await exec('sh', ['-c', 'echo "$GITHUB_TOKEN" | gh auth login --with-token']);
